...
<form method="POST" use:enhance enctype="multipart/form-data" class="flex flex-col px-6 py-12">
	...
	<div class="mt-6 space-y-3">
		...
		<Form.Field {form} name="bio">
			...
			<Form.Description>
				Bio yang kamu tulis akan muncul di profilmu. Tulis tentang dirimu, minat, dan kegiatan yang
				kamu sukai.
			</Form.Description>
			<Form.FieldErrors />
		</Form.Field>
